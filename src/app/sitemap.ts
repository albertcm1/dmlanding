...
export default function sitemap(): MetadataRoute.Sitemap { return routes.map((route) => ({ url: `https://growth-workspace-search-atlas-3.pages.dev/${route}`, lastModified: new Date("2026-07-18"), changeFrequency: "monthly", priority: route === "" ? 1 : .7 })); }
